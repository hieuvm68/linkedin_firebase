      ...
      {props.articles.length === 0 ? (
        ...
        <Contaier>
          <CommonCard>
            ...
            <Content>
              {props.loading && <img src={"./images/spiner.svg"} />}
              {props.articles.length > 0 &&
                props.articles.map((article, key) => (
                  ...
                  <img src="/images/idea-icon.svg" alt="" /> */}
                    ...
                    <SocialActions>
                      <button>
                        <img src="/images/buttonlike.svg" />
                        <span>Like</span>
                      </button>
                      <button>
                        <img src="/images/buttoncomment.svg" />
                        <span>Comments</span>
                      </button>
                      <button>
                        <img src="/images/buttonshared.svg" />
                        <span>Shared</span>
                      </button>
                      <button>
                        <img src="/images/buttonsend.svg" />
                        <span>Send</span>
                      </button>
                    </SocialActions>
                  </Article>
